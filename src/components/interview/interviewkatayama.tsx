        ...
        <div className={styles.featuresArea}>
          ...
          <>
            ...
            <div className={styles.featuresDescription}>
              ...
              <br />
              <br />
              GOOD-DAYでサロン見学をしてみてチャレンジ精神が沸き上がったので、不安ももちろんありましたが、思い切って初めてみました。
              <br />
              <br />
              働き方について色々と考えていた時期にGOODーDAYに出会ったこともあり、これはやってみるしかない！と思ったことを覚えています(笑)
              <br />
              <br />
              <Image
                className={styles.centerImage}
          ...
          <>
            ...
            <div className={styles.featuresDescription}>
              ...
              <br />
              <br />
              例えるなら、下りのエスカレーターを登り続けるような環境で、「歩いても現状維持」だからこそ「ずっと登り続けないといけない」というのはフリーランスという働き方だと思います。
              <br />
              <br />
              だからこそ自分で決めた道を進み続けるのが好きな人には向いてると思います！
              <br />
              <br />
