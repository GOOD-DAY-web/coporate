      ...
      <div className={styles.features}>
        ...
        <div className={styles.featuresArea}>
          ...
          <>
            ...
            />
            <h2 className={styles.featuresTitle}>
              GOOD-DAY入会から２年経ち感じること
            </h2>
            <div className={styles.featuresDescription}>
              業務委託で働く、独立することに対しての恐怖心がなくなったことは強く感じます。
              <br />
              <br />
              フリーランスに挑戦する時は不安も大きかったですが、今では、たくさんのお客様との出会いがあり、どこでもやっていけるという自信になっています。
              <br />
              <br />
              最初の方は予約が入らない日があったりと不安な時ももちろんありましたが、新規のお客様や紹介いただいたお客様からの予約も増えていきました。
              <br />
              <br />
              去年の12月から休みの配分をきっちり月8日取るようにもなって、不安もなくなりました。
              <br />
              <br />
              フリーランスとしての働き方が確立でき、力を抜きながら頑張ることができるようになってきたと思います！
            </div>
          </>
          <>
          ...
          <>
            ...
            <div className={styles.featuresDescription}>
              ...
              <br />
              <br />
              実際働いていて、頑張りたいことなどの想いに対してバックアップしてくれる環境だと感じているので、
              <br />
              <br />
              思い切って飛び込むことができる環境だと思います。
              <br />
              <br />
              「独立したい」と考えている美容師にとっては、「こんなにやってくれる環境はなかなかないよ！」とおすすめしたいです(笑)
              <br />
              <br />
              備品の発注や、事務作業、経理作業、対外的なホームページやホットペッパービューティーの運用なども行ってくれるし、普段行き届かないところを業者が入ってお掃除もしてくれます。
              <br />
              <br />
              それに接客する各ブースにもタブレットや空気清浄機の設置なども行ってくださり、施術と接客にこんなに集中できて、
              <br />
              <br />
              自由に働ける環境はなかなか無いと思うので、GOOD-DAYに入会できて良かったなと思っています。
              <br />
              <br />
