      ...
      <div className={styles.features}>
        ...
        <div className={styles.featuresArea}>
          ...
          <>
            ...
            <div className={styles.featuresDescription}>
              お客にお出迎えからお見送りまで一対一の接客をしたいという想いが強くありました。
              <br />
              <br />
          ...
          <>
            ...
            <div className={styles.featuresDescription}>
              ...
              <br />
              <br />
              将来お店を出すと考えた時に、その環境に1番近い働き方ができると感じたのでGOOD-DAYを選びました。
              <br />
              <br />
              13年間勤めたサロンを辞めた後、業務委託でフリーランスとして働いていたのですが、
              <br />
              <br />
              お店の売り上げ目標や、出勤必須の日があったりと、自由度が少なく、働きづらさを感じモヤモヤしていたんです。
              <br />
              <br />
              その点、GOOD-DAYだとそういった縛りもなく自由に楽しく働けることで、お客さまにより集中できています。
              <br />
              <br />
          ...
          <>
            ...
            <div className={styles.featuresDescription}>
              周りの人といい関係を築きながらお客さまともしっかり向き合えるようになり、
              <br />
              <br />
              働くことが楽しくなったことが、良かったと強く思うポイントですね！
              <br />
              <br />
              ...
              <br />
              <br />
              独立して自分のお店を持ったら、本来しないといけない運営や経理などの事務作業を運営スタッフの方が行ってくれるのでお客さまへの接客や
              <br />
              <br />
              自分の働き方の確立により集中できるありがたい環境だと思っています。
            </div>
          </>
          <>
            <Image
            ...
            <div className={styles.featuresDescription}>
              ...
              <br />
              <br />
              今では、たくさんのお客さまとの出会いがあり、どこでもやっていけるという自信になっています。
              <br />
              <br />
              最初の頃は予約が入らない日があったりと不安な気持ちももちろんありましたが、新規のお客さまや紹介いただいたお客さまからの予約も増えていきました。
              <br />
              <br />
              今ではフリーランスとしての働き方が確立でき、力を抜きながら頑張ることができています！
            </div>
          </>
          <>
