      ...
      <div className={styles.features}>
        ...
        <div className={styles.featuresArea}>
          ...
          <>
            ...
            <div className={styles.featuresDescription}>
            元々、自分で考えてやり方を決めていけるフリーランスという働き方や独立興味がありました。
            <br />
            <br />
            ...
            <br />
            <br />
            また、売り上げをいくらあげても、手取りはほとんど変わらない現状に嫌気がさし、
            <br />
            <br />
            仕事に対してやる気が無くなっていくのを感じていました。
            <br />
            <br />
          ...
          <>
            ...
            <br />
            <br />
            GOOD-DAYはシェアサロンだから、周りの美容師がみんなフリーランスだからこそ色々なことを教えてもらえる環境はとても心強いです！
            </div>
          </>
          <>
            <h2 className={styles.featuresTitle}>最初と比べて不安は減った？乗り越え方は？</h2>
            <div className={styles.featuresDescription}>
            ...
            <br />
            <br />
            それに、自分の頑張りや成長が結果となって全て返ってくるのでやる気が湧き、不安になった時の行動力にもつながっています。
            <br />
            <br />
          ...
          <>
            ...
            <br />
            <br />
            手取りは入会1か月で2倍以上になりましたし、人間関係の悩みも一切なくなりました！
            <br />
            <br />
          ...
          <>
            ...
            <div className={styles.featuresDescription}>
            店舗を構えるのもいいなとも思っていますが、今は月70万円以上の売り上げが目標です！
            <br />
            <br />
