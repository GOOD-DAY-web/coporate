      ...
      <div className={styles.features}>
        ...
        <div className={styles.featuresArea}>
          ...
          <>
            ...
            <div className={styles.featuresDescription}>
              「美容院の先輩の姿＝未来の自分の姿だと考えた時に自分の将来が見えなかった」これが1番の理由です。
              <br />
              <br />
          ...
          <>
            ...
            <div className={styles.featuresDescription}>
              ...
              <br />
              <br />
              その結果、3ヶ月程で大阪の時の収入を越えることができました！
              <br />
              <br />
              集客においての不安はフリーランスで働く以上消えませんが、だからこそその不安が原動力になり頑張ることができています。
            </div>
            <Image
              className={styles.centerImage}
          ...
          <>
            ...
            <div className={styles.featuresDescription}>
              ...
              <br />
              <br />
              ただ、実際フリーランスとしてGOODーDAYで働いてみると、自分の頑張りや行動ももちろん必要ですが、
              <br />
              <br />
              GOOD-DAYにはフリーランスの先輩がいっぱいいますし、色々なことを教えてくれるので一歩踏み出して欲しいです。
              <br />
              <br />
