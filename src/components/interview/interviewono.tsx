      ...
      <div className={styles.features}>
        ...
        <div className={styles.featuresArea}>
          ...
          <>
            ...
            <div className={styles.featuresDescription}>
              勤めていた時から、独立したいという思いが強かったこともあり、フリーランスという働き方を選びました。
              <br />
              <br />
              GOOD-DAYに入会することを検討していた当時は、「年齢的にも独立するなら早く動きたい」
              <br />
              <br />
              という焦りに似たような思いが強かったかもしれません。早く一歩前進したいという感じですね！
              <br />
              <br />
              そんな時、美容師の友達がGOOD-DAYで働いていることを知り、話を聞いているうちに、
              <br />
              <br />
              GOOD-DAYの自由な働き方なら、独立のステップアップができると思い、挑戦することにしました。
              <br />
              <br />
            </div>
          </>
          <>
            ...
            <div className={styles.featuresDescription}>
              自由度が高く働きやすそうだという印象に加えて、立地もよく駐車場も広いので、お客さまが来店しやすそうだったからですね。
              <br />
              <br />
              そもそもフリーランスとして自由に働けるシェアサロン自体が岡山には少ないですし、
              <br />
              <br />
              全ブース個室ということにも驚きました。
              <br />
              ...
              <br />
              <br />
              お客さまからも、立地の良さや個室空間についてお褒めの言葉をよくいただきます！
            </div>
            <Image
              className={styles.centerImage}
          ...
          <>
            ...
            <div className={styles.featuresDescription}>
              ...
              <br />
              <br />
              私はアウトドアが好きなので、家族とキャンプに行こうと思っても、勤めていると週末の絡む連休などは取りづらかったんですが、
              <br />
              <br />
              GOOD-DAYでは、予約管理をしっかり行うことで家族との時間を増やすことが出来たのでとても嬉しいです！
              <br />
              <br />
              私はアウトドアも好きなので、家族とのキャンプの時間などを増やすことができるようになったので嬉しいです！(笑)
              <br />
              <br />
              それに、シェアサロンだからこそ、「仲間がいる」ということも働いていて楽しいポイントですね。
              <br />
              <br />
              独立したら自分で色々な情報を掴みに行かないといけませんが、GOOD-DAYには、
              <br />
              <br />
              ...
              <br />
              <br />
              GOOD-DAYはフリーランスの集まりだからこそやる気のある人が多く、自分も「頑張ろう！」と良い影響を日々受けています！
              <br />
              <br />
              たまに今までのことを振り返ることがあるのですが、その度に「今が1番充実しているな」と感じるので、
              <br />
              <br />
              GOOD-DAYに来て良かったなと改めて思います。
            </div>
            <Image
              className={styles.centerImage}
          ...
          <>
            ...
            <div className={styles.featuresDescription}>
              ...
              <br />
              <br />
              GOOD-DAYの働き方だと、出勤中でも空いた時間に家に帰ってやるべきことや好きなことをできるので、
              <br />
              <br />
              時間を効率的に使えて充実度が上がりました。
              <br />
              <br />
          ...
          <>
            ...
            <div className={styles.featuresDescription}>
              ...
              <br />
              <br />
              将来的には自宅兼美容室を建てたいと考えているので、初心を忘れずに、
              <br />
              <br />
