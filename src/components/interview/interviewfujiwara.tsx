        ...
        <div className={styles.featuresArea}>
          ...
          <>
            ...
            <div className={styles.featuresDescription}>
              ...
              <br />
              <br />
              私は一人一人のお客さまに最初から最後まで丁寧に接客したいのですが、勤めているとカットだけ私が行い、カラーは他のスタッフに任せることが多く、
              <br />
              <br />
              1人のお客さまに時間をかけれないのが嫌でした。そもそも私は人に何かを頼むことが苦手なこともあり、ストレスに感じていました。
              <br />
              <br />
              ですが、フリーランスとして1人で働くならそのストレスはなくなるし、特にGOOD-DAYは全部屋個室なので
              <br />
              <br />
              お客さまに丁寧に接客できる理想の姿が見えたのでフリーランスという道を選びました。
              <br />
              <br />
              実際働いてみても、お客さまに自分の理想としていた接客ができるのでストレスフリーで働けています。
              <br />
              <br />
              それと、これは主婦目線の気持ちなのですが、子育てをしていると、どうしても子供の予定に合わせて休みたい時や早めに帰りたい時があるんです。
              <br />
              <br />
              そういった時に誰の許可も得ずに自由に休めるのは本当に働きやすいですね！
              <br />
              <br />
          ...
          <>
            ...
            <div className={styles.featuresDescription}>
              ...
              <br />
              <br />
              勤めているときは、家庭と仕事を両立することの難しさを感じることが多々ありました。
              <br />
              <br />
              家族との時間は大切だと思うのですが、自分の好きな仕事を続けるにはその時間を削るしかないと諦めていました。
              <br />
              <br />
              でも、GOOD-DAYで働き始めて、家族との時間を作り易くなりました。
              <br />
              <br />
              勤めていた頃は、子供の体調が悪くなって休みたい時や、お迎えに早く行かないといけない時など、
              <br />
              <br />
              周りのスタッフに気を遣って休みづらいことが私にとってストレスだったんです。
              <br />
              <br />
              でもGOOD-DAYではそんな気遣い自体不要で、子育てへのストレスが少なくなったなと感じています。
              <br />
              <br />
              家庭も仕事も妥協しないでいい環境に出会えて本当に良かったです！
            </div>
            <Image
              className={styles.centerImage}
          ...
          <>
            ...
            <div className={styles.featuresDescription}>
              ...
              <br />
              <br />
              予約でいっぱいの日でも、「勤めにいく」ではなく「好きなことをしに行く」という感覚なので、ストレスが本当に減りました！(笑)
              <br />
              <br />
