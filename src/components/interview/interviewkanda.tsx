      ...
      <div className={styles.features}>
        ...
        <div className={styles.featuresArea}>
          ...
          <>
            ...
            <div className={styles.featuresDescription}>
              岡山県内の美容専門学校卒業後、岡山県内のサロンに会社員として12年間勤める。
              <br />
              <br />
          ...
          <>
            ...
            <div className={styles.featuresDescription}>
              ...
              <br />
              <br />
              会社という看板が無くなった時に、技術、接客、集客で自分にどれだけ実力があるか試せる環境だと思ったので挑戦することに迷いはありませんでした。
            </div>
            <Image
              className={styles.centerImage}
          ...
          <>
            ...
            <div className={styles.featuresDescription}>
              ...
              <br />
              <br />
              僕の場合は「独立するんだから責任は当然」だし、逆にその方がやりがいを感じます。
              <br />
              <br />
            ...
            <Image
              className={styles.centerImage}
              src={"/media/interviewkanda001.jpg"}
              alt={"神田さんインタビュー画像02"}
              width={1080}
              height={800}
            />
          ...
          <>
            ...
            <div className={styles.featuresDescription}>
              独立するときの1番の不安が「集客」だと思います。やはり僕も最初はそうでした。
              <br />
              <br />
          ...
          <>
            ...
            <div className={styles.featuresDescription}>
              ...
              <br />
              <br />
              だからこそ、知っておくことってとても大切なんです。こだわりを追求する楽しみも増えると思います！笑
            </div>
            <Image
              className={styles.centerImage}
